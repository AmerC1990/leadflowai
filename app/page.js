...
export default function Home() {
  return (
    <>
      <Head>
        <title>LeadFlowAI — AI Lead Assistant for Dentists</title>
        <meta
          name="description"
          content="LeadFlowAI instantly responds to dental patient inquiries, qualifies Invisalign and implant leads, and books consultations automatically — 24/7."
        />
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mt-6 text-sm text-slate-300">
                <p>
                  Trusted by early dental practices to capture high-value cases and
              ...
              <div className="relative rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 shadow-2xl p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="max-w-[82%] ml-auto rounded-2xl bg-blue-500 px-3 py-2">
                    Absolutely! We do. I just need to ask a couple quick questions
        ...
        <section className="bg-slate-900 border-y border-slate-800 px-6 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 text-sm text-slate-300">
              ...
              It answers FAQs, asks qualifying questions, and follows rules you approve —
